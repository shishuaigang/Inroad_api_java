...
public class SendMail {
    ...
    public void sendMail() throws Exception {
        ...
        // 3. 创建一封邮件
        MimeMessage message = createMimeMessage(session, EmailAccount, toall, folder_name);
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, InternetAddress[] receiveMail, String t_snap) throws Exception {
        ...
        /*邮件主题*/
        message.setSubject("Inroad API Scan Test Report", "UTF-8");

        /*添加邮件正文（可以使用html标签）*/
        MimeBodyPart text = new MimeBodyPart();
        text.setContent("Hi all,<br>&nbsp&nbspThis is the test report for inroad api scan.",
                "text/html;charset=UTF-8");

        /*添加附件*/
        MimeBodyPart attach = new MimeBodyPart();
        DataHandler dh = new DataHandler(new FileDataSource("/Users/shishuaigang/testResults/" + t_snap + "/result.html"));  // 读取本地文件
